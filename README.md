...
Embora o sistema completo inclua um backend conténdo integração com IA, este repositório abrange exclusivamente a camada de interface, já preparada para integração via API.
